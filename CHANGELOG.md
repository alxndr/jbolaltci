...
- `docs/architecture-decisions/`: adopted the ADR practice from [alxndr/sparse-boolean-codec](https://github.com/alxndr/sparse-boolean-codec), starting with the decision to use an in-memory cache for the client-side build rather than IndexedDB or sql.js.
