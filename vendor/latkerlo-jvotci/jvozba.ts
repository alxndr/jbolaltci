// @ts-nocheck
// Type-checking disabled for this ported file: see vendor/latkerlo-jvotci/NOTICE.md
// for why. Only `export`/`import` statements were added.
/*
...
import { VALID, MZ_VALID, BANNED_TRIPLES, INITIAL } from "./data.js";
import { RAFSI_LIST } from "./rafsi.js";
import {
  Tarmi, BrivlaType, YHyphenSetting, ConsonantSetting,
  isConsonant, isVowel, isGlide, isOnlyLojbanCharacters, containsConsonant,
  isValidRafsi, rafsiTarmi, stripHyphens, tarmiIgnoringHyphen,
} from "./tarmi.js";
import {
  NonLojbanCharacterError, NoLujvoFoundError, NotBrivlaError,
  DecompositionError, InvalidClusterError, NotZihevlaError,
} from "./exceptions.js";
import { analyseBrivla, checkZihevlaOrRafsi, isSlinkuhi, normalise } from "./tools.js";
import { jvokaha2 } from "./katna.js";
