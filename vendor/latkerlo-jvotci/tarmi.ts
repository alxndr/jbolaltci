...
// for why (this project's strict/noUncheckedIndexedAccess settings are stricter
// than upstream's, and the algorithm's logic is left untouched rather than
// reworked to satisfy them). Only `export`/`import` statements were added.
/*
...
import { VALID, MZ_VALID, INITIAL, ZIhEVLA_INITIAL } from "./data.js";
import { DecompositionError } from "./exceptions.js";
