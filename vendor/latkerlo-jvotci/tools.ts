...
// Only `export`/`import` statements were added.
/*
Copyright (c) 2023-2024 latkerlo (https://github.com/latkerlo)
Licensed under the MIT License
*/

import { INITIAL, VALID, MZ_VALID, BANNED_TRIPLES, FOLLOW_VOWEL_CLUSTERS } from "./data.js";
import {
  Tarmi, BrivlaType, YHyphenSetting, ConsonantSetting,
  isVowel, isConsonant, isGlide, isGismu, isValidRafsi, rafsiTarmi, stripHyphens,
  isZihevlaInitialCluster, isZihevlaMiddleCluster, splitVowelCluster,
} from "./tarmi.js";
import { DecompositionError, InvalidClusterError, NotBrivlaError, NotZihevlaError } from "./exceptions.js";
import { jvokaha, jvokaha2 } from "./katna.js";
